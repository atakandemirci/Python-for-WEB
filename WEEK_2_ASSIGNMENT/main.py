...
# @app.route("/")
# def hello_world():
# this returns the base.html template in the template directory
...
# here we explicitly call the type of webrequest this manages - A post - a post sends data with the request - it is supposed to be more secure
@app.route("/secondpage", methods=['POST'])
def go_shopping():
    # this is how we pull form data from a post request
